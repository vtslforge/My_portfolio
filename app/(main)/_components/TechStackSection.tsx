...
import { FaReact, FaGitAlt, FaAws, FaDocker } from 'react-icons/fa';
        ...
        <div className="flex flex-wrap justify-center gap-x-8 gap-y-12">
          {skillsset.map((item, index) => (
            <motion.div
              ...
              <span className="text-[0.65rem] font-medium font-InterFont text-zinc-400 dark:text-zinc-500 group-hover:text-zinc-800 dark:group-hover:text-zinc-200 tracking-wider uppercase transition-colors">
                {item.label}
              </span>
            </motion.div>
          ))}
